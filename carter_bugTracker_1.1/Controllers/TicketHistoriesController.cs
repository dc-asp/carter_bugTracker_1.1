...
namespace carter_bugTracker_1._1.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,UserId,PropertyName,OldValue,NewValue,Changed,Created,Updated")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,UserId,PropertyName,OldValue,NewValue,Changed,Created,Updated")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
